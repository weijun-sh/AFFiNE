...
export interface IndexedDBV1DocStorageOptions extends DocStorageOptions {}

/**
 * @deprecated readonly
 */
export class IndexedDBV1DocStorage extends DocStorage<IndexedDBV1DocStorageOptions> {
